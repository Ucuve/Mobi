...
class Summary {
  Summary({required this.titles, required this.pageid, required this.extract, required this.extractHtml, required this.lang, required this.dir, this.url, this.description});
    ...
    return switch (json) {
      {
        ...
        'content_urls': {'desktop': {'page': final String url}, 'mobile': {'page': String _}},
  ...
  @override
  String toString() => 'Summary[titles=$titles, pageid=$pageid, extract=$extract, extractHtml=$extractHtml, lang=$lang, dir=$dir, description=$description]';
}